...
if (Modernizr.webgl) {
    ...
    d3.queue()
        .defer(d3.csv, "changeovertime/data/data0.csv")
        .defer(d3.json, "changeovertime/data/config.json")
        .defer(d3.json, "changeovertime/data/geog.json")
        .await(ready);
    ...
    function ready(error, data, config, geog) {
        ...
        function onPlay() {
            ...
            if(d3.select("#play").classed('playing')===true){
                ...
                d3.select("#playImage").attr("src", "changeovertime/images/play.svg");
                setButtons();
            ...
            // if paused, play
                ...
                d3.select("#playImage").attr("src", "changeovertime/images/pause.svg");
